...
values."
  ...
  (setq-default
   ...
   ;; the commands bound to the current stroke sequence. (default 0.4)
...
you should place you code here."
  ...
  (spacemacs|do-after-display-system-init
   (setq
    ...
    initial-buffer-choice (get-buffer "*spacemacs*"))
   (spaceline-compile))
  ...
  ; FIXME Conflicts with org-bullet
  ...
  ((lambda ()
     (with-eval-after-load 'org-capture
       (add-to-list 'org-capture-templates
                    `("d" "Drill" entry (function tmrts/find-drill-file)
                      "* %?"
                      :empty-lines 1)))
     ...
     (global-set-key "\C-cd" 'org-drill-capture-topic)

     (add-to-list 'org-drill-card-type-alist
                  '("topic"
                    org-drill-present-topic
                    org-drill-show-answer-topic
                    t))))

  (eval-after-load 'org-list
    '(add-hook
      'org-checkbox-statistics-hook (function tmrts/checkbox-list-complete)))
